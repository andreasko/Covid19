...
function state_prediction_plot(data::ImperialReportUSA.Data, state_idx, predictions_state::AbstractMatrix, e_deaths_state::AbstractMatrix, Rt_state::AbstractMatrix, infectiousness::AbstractMatrix; normalize_pop::Bool = false, main_title="")
...
function state_prediction_plot(data::ImperialReportUSA.Data, state_idx, cases, e_deaths, Rt, infectiousness; kwargs...)
...
function states_prediction_plot(data::ImperialReportUSA.Data, vals::AbstractArray{<:Real, 3}; normalize_pop = false, no_label=false, kwargs...)
    lqs, mqs, hqs = [], [], []
    labels = []
